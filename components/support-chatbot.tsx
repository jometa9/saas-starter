...
import { Send, Bot, User, MessageCircle, RotateCcw } from "lucide-react";
...
const faqs: FAQ[] = [
  {
    ...
    answer: "To start using IPTRADE, you first need to create an account and select a plan that fits your needs. Once registered, you can download our software and follow the initial setup guide in your dashboard."
  },
  {
      ...
      <Card>
        <CardHeader>
          ...
          <p className="text-muted-foreground">
            Beta, help improve my responses by leaving your feedback
          </p>
        </CardHeader>
        <CardContent>
